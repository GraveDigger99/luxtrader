(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".products__slider")) new core(".quotes__slider", {
                ...
                navigation: {
                    prevEl: ".controll-quotes__decor_next",
                    nextEl: ".controll-quotes__decor_next"
                },
                on: {}
            });
            if (document.querySelector(".products__slider")) new core(".products__slider", {
                ...
                navigation: {
                    prevEl: ".controll-slider-products__arrow_prev",
                    nextEl: ".controll-slider-products__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.1
        ...
        const test = document.querySelector(".menu__icon");
        userHeaderIcon.addEventListener("click", (function(e) {
            document.documentElement.classList.toggle("open");
        }));
        document.addEventListener("click", (function(e) {
            if (e.target.closest(".user-header__icon") || document.documentElement.closest("menu-open")) document.documentElement.classList.remove("menu-open");
        }));
        ...
        document.addEventListener("click", (function(e) {
            let targetElement = e.target;
            if (!targetElement.closest(".user-header__icon")) document.documentElement.classList.remove("open");
        }));
        const controllSlider = document.querySelector(".controll-quotes__circle");
        if (controllSlider) document.addEventListener("click", (function(e) {
            let targetElement = e.target;
            if (targetElement.closest(".controll-quotes__circle")) controllSlider.classList.toggle("active");
        }));
        isWebp();
        menuInit();
        formFieldsInit({
